...
// UnimplementedSTNServer can be embedded to have forward compatible implementations.
type UnimplementedSTNServer struct {
}

func (*UnimplementedSTNServer) StealInterface(ctx context.Context, req *STNRequest) (*STNReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StealInterface not implemented")
}
func (*UnimplementedSTNServer) ReleaseInterface(ctx context.Context, req *STNRequest) (*STNReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ReleaseInterface not implemented")
}
func (*UnimplementedSTNServer) StolenInterfaceInfo(ctx context.Context, req *STNRequest) (*STNReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method StolenInterfaceInfo not implemented")
}
