...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LinuxIf) DeepCopyInto(out *LinuxIf) {
	*out = *in
	if in.IPAddresses != nil {
		in, out := &in.IPAddresses, &out.IPAddresses
		*out = make([]string, len(*in))
...
func (in *LinuxIf) DeepCopy() *LinuxIf {
	if in == nil {
		return nil
	}
	out := new(LinuxIf)
...
func (in LinuxInterfaces) DeepCopyInto(out *LinuxInterfaces) {
	{
		in := &in
		*out = make(LinuxInterfaces, len(*in))
		for i := range *in {
...
func (in *Node) DeepCopyInto(out *Node) {
	*out = *in
	...
	if in.LinuxInterfaces != nil {
		in, out := &in.LinuxInterfaces, &out.LinuxInterfaces
