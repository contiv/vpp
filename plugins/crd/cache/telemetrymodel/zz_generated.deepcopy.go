...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *Pod_Label) DeepCopyInto(out *Pod_Label) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new Pod_Label.
func (in *Pod_Label) DeepCopy() *Pod_Label {
	if in == nil {
		return nil
	}
	out := new(Pod_Label)
