...
func getRawK8sPodTestData() []string {
	return []string{
		...
		`{
			...
			"name": "kube-dns-86f4d74b45-vvkgj",
			"namespace": "kube-system"
		}`,
		`{
			"container": [
		...
		`{
			...
			"name": "tiller-deploy-895d57dd9-xz964",
			"namespace": "kube-system"
		}`,
	}
}
