...
func getRawPodTestData() []string {
	return []string{
		...
		`{
			...
			"name": "kube-dns-86f4d74b45-qxxmq",
			"namespace": "kube-system"
		}`,
		`{
			"container": [
