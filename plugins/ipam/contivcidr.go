...
func dissectContivCIDR(ipamConfig *contivconf.IPAMConfig) (subnets *contivconf.CustomIPAMSubnets, err error) {
	...
	// podSubnetCIDR has a requirement of minimum 65K pod mainIP addresses use 16-bit space
	...
	// vppHostSubnetCIDR has a requirement of minimum 65K pod mainIP addresses use 16-bit space
