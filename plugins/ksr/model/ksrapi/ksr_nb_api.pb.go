...
func (*KsrStats) Descriptor() ([]byte, []int) { return fileDescriptorKsrNbApi, []int{0} }
...
func (*Stats) Descriptor() ([]byte, []int) { return fileDescriptorKsrNbApi, []int{1} }
...
func init() { proto.RegisterFile("ksr_nb_api.proto", fileDescriptorKsrNbApi) }

var fileDescriptorKsrNbApi = []byte{
