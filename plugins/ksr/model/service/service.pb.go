...
func (Service_ServicePort_IntOrString_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_service_44ed2366dd244ab6, []int{0, 0, 0, 0}
}
...
type Service struct {
	...
	// feature.
	// +optional
	LoadbalancerIp string `protobuf:"bytes,9,opt,name=loadbalancer_ip,json=loadbalancerIp,proto3" json:"loadbalancer_ip,omitempty"`
	...
	// +optional
	ExternalTrafficPolicy string `protobuf:"bytes,11,opt,name=external_traffic_policy,json=externalTrafficPolicy,proto3" json:"external_traffic_policy,omitempty"`
	...
	// +optional
	HealthCheckNodePort  int32    `protobuf:"varint,12,opt,name=health_check_node_port,json=healthCheckNodePort,proto3" json:"health_check_node_port,omitempty"`
...
func (*Service) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_44ed2366dd244ab6, []int{0}
}
...
func (*Service_ServicePort) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_44ed2366dd244ab6, []int{0, 0}
}
...
func (*Service_ServicePort_IntOrString) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_44ed2366dd244ab6, []int{0, 0, 0}
}
...
func init() { proto.RegisterFile("service.proto", fileDescriptor_service_44ed2366dd244ab6) }

var fileDescriptor_service_44ed2366dd244ab6 = []byte{
