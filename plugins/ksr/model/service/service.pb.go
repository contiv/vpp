...
type Service struct {
	...
	// +optional
	ClusterIp string `protobuf:"bytes,5,opt,name=cluster_ip,json=clusterIp" json:"cluster_ip,omitempty"`
	...
	// +optional
	ServiceType string `protobuf:"bytes,6,opt,name=service_type,json=serviceType" json:"service_type,omitempty"`
	...
	// feature.
	// +optional
	LoadbalancerIp string `protobuf:"bytes,9,opt,name=loadbalancer_ip,json=loadbalancerIp" json:"loadbalancer_ip,omitempty"`
	...
	// +optional
	LoadbalancerSourceRanges []string `protobuf:"bytes,10,rep,name=loadbalancer_source_ranges,json=loadbalancerSourceRanges" json:"loadbalancer_source_ranges,omitempty"`
	...
	// +optional
	ExternalTrafficPolicy string `protobuf:"bytes,11,opt,name=external_traffic_policy,json=externalTrafficPolicy" json:"external_traffic_policy,omitempty"`
	...
	// +optional
	HealthCheckNodePort int32 `protobuf:"varint,12,opt,name=health_check_node_port,json=healthCheckNodePort" json:"health_check_node_port,omitempty"`
}
...
func (*Service_ServicePort) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0, 0} }
...
type Service_ServicePort_IntOrString struct {
	Type      Service_ServicePort_IntOrString_Type `protobuf:"varint,1,opt,name=type,enum=service.Service_ServicePort_IntOrString_Type" json:"type,omitempty"`
	IntVal    int32                                `protobuf:"varint,2,opt,name=int_val,json=intVal" json:"int_val,omitempty"`
	StringVal string                               `protobuf:"bytes,3,opt,name=string_val,json=stringVal" json:"string_val,omitempty"`
}
...
var fileDescriptor0 = []byte{
	...
	,
}
