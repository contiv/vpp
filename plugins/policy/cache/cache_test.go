...
func TestUpdate(t *testing.T) {
	...
	// Add pods.
	dataChange1 := datasnc.Put(podmodel.Key(pod1.Name, pod1.Namespace), pod1aModel)
	gomega.Expect(pc.Update(dataChange1)).To(gomega.BeNil())
	dataChange2 := datasnc.Put(podmodel.Key(pod2.Name, pod2.Namespace), pod2aModel)
	gomega.Expect(pc.Update(dataChange2)).To(gomega.BeNil())
	dataChange3 := datasnc.Put(podmodel.Key(pod3.Name, pod3.Namespace), pod3aModel)
	gomega.Expect(pc.Update(dataChange3)).To(gomega.BeNil())

	//Update Pods.
	dataChange4 := datasnc.Put(podmodel.Key(pod1.Name, pod1.Namespace), pod1bModel)
	gomega.Expect(pc.Update(dataChange4)).To(gomega.BeNil())
	dataChange5 := datasnc.Put(podmodel.Key(pod2.Name, pod2.Namespace), pod2bModel)
	gomega.Expect(pc.Update(dataChange5)).To(gomega.BeNil())
	dataChange6 := datasnc.Put(podmodel.Key(pod3.Name, pod3.Namespace), pod3bModel)
	...
	dataChange7 := datasnc.Delete(podmodel.Key(pod1.Name, pod1.Namespace))
	gomega.Expect(pc.Update(dataChange7)).To(gomega.BeNil())
	dataChange8 := datasnc.Delete(podmodel.Key(pod2.Name, pod2.Namespace))
	gomega.Expect(pc.Update(dataChange8)).To(gomega.BeNil())

	// Add Namespaces.
	nsChange1 := datasnc.Put(namespace.Key(testdata.Namespace1), testdata.TestNamespace1)
	gomega.Expect(pc.Update(nsChange1)).To(gomega.BeNil())
	nsChange2 := datasnc.Put(namespace.Key(testdata.Namespace2), testdata.TestNamespace2)
	gomega.Expect(pc.Update(nsChange2)).To(gomega.BeNil())

	// Update Namespaces.
	nsChange1 = datasnc.Put(namespace.Key(testdata.Namespace1), testdata.TestNamespace1b)
	gomega.Expect(pc.Update(nsChange1)).To(gomega.BeNil())
	nsChange2 = datasnc.Put(namespace.Key(testdata.Namespace2), testdata.TestNamespace2b)
	gomega.Expect(pc.Update(nsChange2)).To(gomega.BeNil())
	//Delete Namespaces.
	...
	nsChange1 = datasnc.Delete(namespace.Key(testdata.Namespace1))
	gomega.Expect(pc.Update(nsChange1)).To(gomega.BeNil())
	nsChange2 = datasnc.Delete(namespace.Key(testdata.Namespace2))
	gomega.Expect(pc.Update(nsChange2)).To(gomega.BeNil())

	// Add Policies.
	policyChange1 := datasnc.Put(policymodel.Key(testdata.TestPolicy1.Name, testdata.TestPolicy1.Namespace), testdata.TestPolicy1)
	gomega.Expect(pc.Update(policyChange1)).To(gomega.BeNil())
	policyChange2 := datasnc.Put(policymodel.Key(testdata.TestPolicy2.Name, testdata.TestPolicy2.Namespace), testdata.TestPolicy2)
	gomega.Expect(pc.Update(policyChange2)).To(gomega.BeNil())
	policyChange3 := datasnc.Put(policymodel.Key(testdata.TestPolicy3.Name, testdata.TestPolicy3.Namespace), testdata.TestPolicy3)
	gomega.Expect(pc.Update(policyChange3)).To(gomega.BeNil())

	//Update Policies.
	policyChange1 = datasnc.Put(policymodel.Key(testdata.TestPolicy1b.Name, testdata.TestPolicy1b.Namespace), testdata.TestPolicy1b)
	gomega.Expect(pc.Update(policyChange1)).To(gomega.BeNil())
	policyChange2 = datasnc.Put(policymodel.Key(testdata.TestPolicy3b.Name, testdata.TestPolicy3b.Namespace), testdata.TestPolicy3b)
	gomega.Expect(pc.Update(policyChange2)).To(gomega.BeNil())
	...
	policyChange1 = datasnc.Delete(policymodel.Key(testdata.TestPolicy1.Name, testdata.TestPolicy1.Namespace))
	gomega.Expect(pc.Update(policyChange1)).To(gomega.BeNil())
	policyChange2 = datasnc.Delete(policymodel.Key(testdata.TestPolicy2.Name, testdata.TestPolicy2.Namespace))
	gomega.Expect(pc.Update(policyChange2)).To(gomega.BeNil())
...
func TestResync(t *testing.T) {
	...
	resyncEv := datasnc.Resync(keyPrefixes...)
	gomega.Expect(pc.Resync(resyncEv)).To(gomega.BeNil())
}
