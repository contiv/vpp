...
// LookupNamespacesByLabelSelector is not implemented by the mock.
func (mpc *MockPolicyCache) LookupNamespacesByLabelSelector(nsLabelSelector *policymodel.Policy_LabelSelector) (namespaces []nsmodel.ID) {
	return nil
}
