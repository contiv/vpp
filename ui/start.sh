...
case "$OSTYPE" in
  ...
  linux*)
    ...
    google-chrome --user-data-dir="/var/tmp/Chrome" --disable-web-security "http://localhost:32500" || echo "Open URL http://localhost:32500 in your browser with disabled web security."
    ;;
